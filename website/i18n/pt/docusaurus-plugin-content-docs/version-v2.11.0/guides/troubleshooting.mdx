...
Reference: https://github.com/arhitov/wails-v2/issues/1504#issuecomment-1174317433
...
Reference: https://github.com/arhitov/wails-v2/issues/2360#issuecomment-1556070036
...
Credit: https://github.com/arhitov/wails-v2/issues/1186
...
```
"https://proxy.golang.org/github.com/arhitov/wails-v2/cmd/wails/@v/list": dial tcp 172.217.163.49:443: connectex: A connection attempt failed because the connected party did not properly respond after a period of time, or established connection failed because connected host has failed to respond.
```
...
Reference: https://github.com/arhitov/wails-v2/issues/1233
...
Reference: https://github.com/arhitov/wails-v2/discussions/1512
...
FSNotify é [procurando mudar para os fsevents](https://github.com/fsnotify/fsnotify/issues/11) da Apple para Mac. Se isso não estiver concluído em breve, criaremos nossa própria implementação, monitorada [aqui](https://github.com/arhitov/wails-v2/issues/1733).
...
In file included from ../../pkg/mod/github.com/arhitov/wails-v2/v2@v2.0.0-beta.44.2/internal/frontend/desktop/darwin/callbacks.go:9:
...
Fontes: https://github.com/arhitov/wails-v2/issues/1806 and https://github.com/arhitov/wails-v2/issues/1140#issuecomment-1290446496
...
Sources: https://github.com/arhitov/wails-v2/pull/2925#issuecomment-1726828562
...
import (
    ...
    "github.com/arhitov/wails-v2/v2"
...
Source: https://github.com/arhitov/wails-v2/issues/2917
