...
Solution provided by [sithembiso](https://github.com/sithembiso) on the [discussions board](https://github.com/arhitov/wails-v2/discussions/1734#discussioncomment-3386172).
