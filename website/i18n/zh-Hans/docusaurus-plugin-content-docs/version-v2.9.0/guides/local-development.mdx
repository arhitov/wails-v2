...
- `git clone https://github.com/arhitov/wails-v2`
...
`replace github.com/arhitov/wails-v2/v2 => <clonedir>`

示例：

在 Windows 上：`replace github.com/arhitov/wails-v2/v2 => C:\Users\leaan\Documents\wails-v2-beta\wails\v2`

在'nix 上：`replace github.com/arhitov/wails-v2/v2 => /home/me/projects/wails/v2`
