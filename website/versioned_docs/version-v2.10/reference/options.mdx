...
See [issue 3240](https://github.com/arhitov/wails-v2/issues/3240) for details
...
Default (Linux): Due to [#2977](https://github.com/arhitov/wails-v2/issues/2977,), if `options.Linux` is nil
