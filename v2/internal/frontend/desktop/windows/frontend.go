...
import (
	...
	"github.com/arhitov/wails-v2/v2/internal/frontend/desktop/windows/win32"
	"github.com/arhitov/wails-v2/v2/internal/frontend/desktop/windows/winc"
	...
	w32consts "github.com/arhitov/wails-v2/v2/internal/platform/win32"
	"github.com/arhitov/wails-v2/v2/internal/system/operatingsystem"
	...
	"github.com/arhitov/wails-v2/v2/pkg/options/windows"
...
func (f *Frontend) Run(ctx context.Context) error {
	...
	mainWindow.OnSize().Bind(func(arg *winc.Event) {
		if f.frontendOptions.Frameless {
			...
			// depends on the content in the WebView, see https://github.com/arhitov/wails-v2/issues/1319
			...
			if event != nil && event.Type == w32.SIZE_MINIMIZED {
				...
				// Reference: https://github.com/arhitov/wails-v2/issues/3951
