...
import (
	_ "github.com/arhitov/wails-v2/v2/internal/goversion" // Add Compile-Time version check for minimum go version
	"github.com/arhitov/wails-v2/v2/pkg/application"
