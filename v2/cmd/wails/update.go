...
import (
	...
	"github.com/arhitov/wails-v2/v2/internal/github"
)
...
func updateToVersion(targetVersion *github.SemanticVersion, force bool, currentVersion string) error {
	...
	sout, serr, err := shell.RunCommand(homeDir, "go", "install", "github.com/arhitov/wails-v2/v2/cmd/wails@"+desiredVersion)
	if err != nil {
	...
	pterm.Println(color.Green("  require github.com/arhitov/wails-v2/v2 " + desiredVersion))
